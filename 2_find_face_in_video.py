...
def load_known_faces():
    global encodings_of_known_faces, known_face_metadata

    try:
        with open("known_faces.dat", "rb") as face_data_file:
            encodings_of_known_faces, known_face_metadata = pickle.load(face_data_file)
...
def register_new_face(face_encoding, face_image):
    ...
    encodings_of_known_faces.append(face_encoding)
